    ...
    >
      ...
      <div
        style={{
          ...
          boxShadow:
            "0 10px 30px rgba(0,0,0,0.5), inset 0 -5px 15px rgba(0,0,0,0.2)",
        ...
        >
          ...
          <div style={{ display: "flex", gap: "25px", marginBottom: "15px" }}>
            ...
            <div
              style={{
                ...
                animation:
                  expression === "frightened" ? "shake 0.1s infinite" : "none",
              }}
            >
              {expression === "dead" ? (
                <div
          ...
          <div
            style={{
              ...
              backgroundColor: "#333",
              borderRadius:
                expression === "frightened" ? "50% 50% 10px 10px" : "10px",
      ...
      >
        <div
          style={{
            width: "18px",
            height: "25px",
            backgroundColor: expression === "dead" ? "#333" : "#45b7af",
            borderRadius: "8px",
...
function App() {
  ...
  useEffect(() => {
    ...
    const handleClick = (e) => {
      const randomImg =
        HOLE_IMAGES[Math.floor(Math.random() * HOLE_IMAGES.length)];
      const newHole = {
        x: e.clientX,
        y: e.clientY,
        id: Math.random(),
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ color: "#fff", textShadow: "0 2px 10px rgba(0,0,0,0.5)" }}>
          Portfolio Target Practice
        </h1>
        <p style={{ opacity: 0.7 }}>
          The screen is your canvas. Click to shoot.
        </p>
      </div>
    </div>
  );
